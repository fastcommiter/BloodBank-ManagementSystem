...
urlpatterns = [
    ...
    path('login', TemplateView.as_view(template_name='donor/donorlogin.html'), name='home'),
    path('login', TemplateView.as_view(template_name='patient/patientlogin.html'), name='login'),
